...
transaction(brandId:UInt64, schemaId:UInt64, maxSupply:UInt64) {
    prepare(acct: AuthAccount) {
        ...
        let immutableData : {String: AnyStruct} = {
            "contentType" : "mp4",
            "contentUrl"  : "QmRrChrxQGGhRHT84QgYQgtE2ZivpxCxjzf5Ev2SeJg8zR/xG_podium_third_place_Oxford_half.mp4",
            "title"       : "3rd - OXFORD HALF 2022",
            "description" : "3rd Place xG Reward NFT. Presented at the Oxford Half by LimeLight and xG.",
            "nftType"     : "3rdM",
            ...
            "distance" : "21K",
            "thumbnail" : "QmNuWvD9LzJGtJf2tZfHHSsHYMyUbn2HWh7KRDSCrbcaB9/xG_podium_third_place_Oxford_half_THUMB.png",
            "assetBackground" : "xG Black Circular Podium",
            "assetContent" : "Grey Speckled Podium Loop: Bronze 3rd Place",
