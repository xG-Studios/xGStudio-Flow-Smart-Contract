...
transaction(brandId:UInt64, schemaId:UInt64, maxSupply:UInt64) {
    prepare(acct: AuthAccount) {
        ...
        let immutableData : {String: AnyStruct} = {
            "contentType" : "mp4",
            "contentUrl"  : "QmRrChrxQGGhRHT84QgYQgtE2ZivpxCxjzf5Ev2SeJg8zR/xG_participation_nft_Oxford_Half.mp4",
            "title"       : "OXFORD HALF 2022",
            "description" : "The Finish LE xG Reward NFT. Presented at the Oxford Half by LimeLight and xG.",
            "nftType"     : "Finish LE",
            ...
            "distance" : "21K",
            "thumbnail" : "QmNuWvD9LzJGtJf2tZfHHSsHYMyUbn2HWh7KRDSCrbcaB9/xG_participation_nft_Oxford_Half_THUMB.png",
            "assetBackground" : "Black",
            "assetContent" : "Grey Speckled xG Device: Female Runner Hologram",
