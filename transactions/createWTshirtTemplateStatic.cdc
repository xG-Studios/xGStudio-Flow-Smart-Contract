...
transaction(brandId:UInt64, schemaId:UInt64, maxSupply:UInt64) {
    prepare(acct: AuthAccount) {
        ...
        let immutableData : {String: AnyStruct} = {
            "contentType" : "mp4",
            "contentUrl"  : "QmYs7Hxy4Xsp3kLrqcTKn8duDwo7iQTjLUj4jZxYqXzENx/TShirtHIlltopFemaleWhite.mp4",
            "extraContentClass": "Digital Kit Item",
            "extraContentType": "Football Shirt",
            "title"       : "Hilltop Women’s Home Shirt 2022/23",
            ...
            "thumbnail"       : "QmYs7Hxy4Xsp3kLrqcTKn8duDwo7iQTjLUj4jZxYqXzENx/THUMB_TShirtHIlltopFemaleWhite.png",
            "royalties"       : royalties
        }
