    ...
    prepare(acct: AuthAccount) {
        ...
        if (artistVault.check()) {
            ...
            let immutableData : {String: AnyStruct} = {
                "contentType" : "mp4",
                "contentUrl"  : "QmPfCoGa6y8rTvjUcbL64h4MScKzjvy9Ta4fCX3pTxMMWX/xG_GENESIS_CLEANSHEET_V2.mp4",
                "title": "GK Clean Sheet: Hilltop 3 - 0 Virginia Water",  
                "description" : "Clean Sheet: The xG Reward for goalkeepers who keep a clean sheet in a match.\n\nGet xG Rewards for your football achievements.\nBuild your collection - your story.\nUnlock xG experiences.\n\nhttps://linktr.ee/xgstudios",
                "xGRewardType": "GK Clean Sheet",
                ...
                "result" : "W",
                "score" : "3 - 0",
                "thumbnail" : "QmSPFN7uaUaW1H9GsET9HHKudMCLvB5JyFDPxyQ4FoGd5k/CLEANSHEET.png",
                "assetBackground" : "Black",
                "assetContent" : "Genesis GK Clean Sheet",
                "assetArtist" : "Hugo Boesch, Future Romance",
                "royalties" : royalties
                
               
            }
        actorResource.createTemplate(brandId:2, schemaId:5, maxSupply:1, immutableData: immutableData)
